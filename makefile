...
CFLAGS = -std=gnu99 -DCPU_LPC54018JET180=1 -DMG_ARCH=MG_ARCH_FREERTOS_LWIP -DCPU_LPC54018JET180_cm4 -DXIP_IMAGE -DMXL12835F -DCPU_LPC54018 -D__USE_CMSIS -DW25Q128JVFM -DUSE_RTOS=1 -DPRINTF_ADVANCED_ENABLE=1 -DSERIAL_PORT_TYPE_UART=1 -DFSL_RTOS_FREE_RTOS -DSDK_DEBUGCONSOLE=0 -DCR_INTEGER_PRINTF -DPRINTF_FLOAT_ENABLE=0 -D__MCUXPRESSO -DDEBUG -D__NEWLIB__ -DLWIP_TIMEVAL_PRIVATE=0 -Os -fno-common -g3 -Wall -c  -ffunction-sections  -fdata-sections  -ffreestanding  -fno-builtin -fmacro-prefix-map="../$(@D)/"=. -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -fstack-usage -DMAKEBUILD
